...
/*   Updated: 2024/11/26 15:09:26 by benpicar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_write_str(char *str, int len_str, t_flags *flags)
{
	...
	write(flags->fd, &str[flags->negatif + flags->plus + flags->space], \
	len_str - (flags->negatif + flags->plus + flags->space));
	ret = ret + len_str;
	return (ret);
}
